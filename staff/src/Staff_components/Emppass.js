    ...
    <>
      <style>{`
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* Adjusted width for single column form */
        .main-content { padding: 40px 60px; max-width: 600px; margin: 0 auto; width: 100%; } 
        ...
        /* Forced 1-column layout for login style */
        ...
        .primary-btn { background: #4F46E5; color: white; border: none; padding: 12px 30px; border-radius: 8px; font-weight: 600; cursor: pointer; font-size: 16px; transition: all 0.2s ease; width: 100%; max-width: 200px; }
      ...
      <div className="container">
        ...
        <main className="main-content">
          <div className="page-header">
            <h1 className="page-title">Employee Validation</h1>
            <p className="page-subtitle">Enter your login credentials to proceed.</p>
          </div>
