                  ...
                  {currentLeaves.map((leave) => {
                    ...
                    return (
                      <tr key={leave.id}>
                        ...
                        <td style={{...styles.td, maxWidth: '200px', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis'}} title={leave.reason}>{leave.reason}</td>
                        <td style={styles.td}>
                          <span style={{
                            backgroundColor: statusColors.bg, color: statusColors.text,
                            padding: '6px 12px', borderRadius: '20px', fontWeight: '700', fontSize: '0.85rem'
                          }}>
                            {leave.status}
                          </span>
                        </td>
